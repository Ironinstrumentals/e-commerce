...
export class ItemFilter extends Component {
    ...
    setModal(title, description, price, rating) {
    ...
    renderItems(category) {
            ...
            if (store.getState()[category] !== undefined) {
                if (category === 'TV') {
                                    ...
                                    <Card.Body className="CBody">
                                        <ListGroup variant='flush'>
                                            ...
                                            <Link to='/e-commerce/Category/TV/Details' id='DetailsBTN'
                                                  onClick={() => this.setModal(product.title, product.description, product.price, product.rating)}
                                                ...
                                                <Card style={{width: '18rem', height: '425px'}} id={product.id}>
                                                    ...
                                                    <Card.Body className="CBody">
                                                        <ListGroup variant='flush'>
                                                            <ListGroup.Item className='SuperItem'><Card.Title
                                                                id={product.title + 'Title'}>{product.title}</Card.Title></ListGroup.Item>
                                                            <Link to='/e-commerce/Category/Watches/Details'
                                                                  id='DetailsBTN'
                                                                  onClick={() => this.setModal(product.title, product.description, product.price, product.rating)}
                                                                  className='btn btn-outline-primary'>Details</Link>
                                                            <div className="SuperDiv">
                                                        ...
                                                        <Card.Body className="CBody">
                                                            <ListGroup variant='flush'>
                                                                <ListGroup.Item className='SuperItem'><Card.Title
                                                                    id={product.title + 'Title'}>{product.title}</Card.Title></ListGroup.Item>
                                                                <Link
                                                                    to='/e-commerce/Category/Kitchen_Appliances/Details'
                                                                    id='DetailsBTN'
                                                                    onClick={() => this.setModal(product.title, product.description, product.price, product.rating)}
                                                                    className='btn btn-outline-primary'>Details</Link>
                                                                <div className="SuperDiv">
                                                    ...
                                                    <Card style={{ width: '18rem', height: '425px'}} id={product.id}>
                                                        ...
                                                        <Card.Body className="CBody">
                                                            <ListGroup variant='flush'>
                                                                ...
                                                                <Link to='/e-commerce/Store/Details' id='DetailsBTN' onClick={() => this.setModal(product.title, product.description, product.price, product.rating)} className='btn btn-outline-primary'>Details</Link>
                                                                <div className="SuperDiv">
                                                                    <Card.Text className="iflex">
                                                                        ${product.price}
                                                                    </Card.Text>
